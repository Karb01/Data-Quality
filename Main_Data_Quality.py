...
def enviar_email(metodos_com_erro: dict, nome_arquivo: str):
    remetente = "noreplygit@teste.com"  # Mesmo e-mail usado no login SMTP
    destinatario = "seuemail@gmail.com"  # Pode ser qualquer e-mail válido
    ...
    usar_auth = True
    usar_tls = True
    usuario_smtp = "93f0ac001@smtp-brevo.com"
    senha_smtp = "sKOzLApvV1Rdjh0U"  # Ideal: usar variável de ambiente
...
def main():
    ...
    colunas_obrigatorias = ['ChaveNPS', 'Data', 'Telefone', 'Dealer']
    colunas_esperadas = ['data', 'telefone', 'bac', 'dealer', 'nota', 'resposta', 'comentario', 'ChaveNPS']
    ...
    if campos_falhos:
        metodos_com_erro["Algum dos campos obrigatórios não foi enviado corretamente"] = f"Campos com erro: {', '.join(campos_falhos)}"
    ...
    validacoes = {
        ...
        'Algum DDI é diferente do país no qual o número foi enviado': validar_ddi_telefone(df, arquivo),
